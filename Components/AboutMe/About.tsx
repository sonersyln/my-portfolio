  ...
  return (
    <div className="bg-[#121121] pb-[3rem] pt-[4rem] md:pt[8rem]">
      <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center">
        ...
        <div data-aos="fade-left" className="lg:w-[500px] rounded-full mx-auto md:mx-0 mt-[2rem] lg:mt-0 lg:h-[500px] w-[300px] h-[300px] relative  bg-custom-radial-gradient">
          <Image
